import { signOut, getAuth } from "https://www.gstatic.com/firebasejs/9.22.0/firebase-auth.js";
...
document.addEventListener("DOMContentLoaded", async () => {  
  ...
  const auth = getAuth(); // garanta que o auth está inicializado
...
document.querySelectorAll("btnLogout").forEach(btn => {
  btn.addEventListener("click", async (e) => {
    e.preventDefault();
    await signOut(auth);
    window.location.href = "/refugi-auth/index.html"; // ajuste o caminho conforme seu projeto
  });
});
